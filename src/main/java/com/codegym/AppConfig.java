...
//    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        // Image resource.
        registry.addResourceHandler("/thanh/**") //
    ...
    public void addFormatters(FormatterRegistry registry) {
        registry.addFormatter(new ProvinceFormatter(aplicationContext.getBean(ProvinceService.class)));
    }
    @Bean
